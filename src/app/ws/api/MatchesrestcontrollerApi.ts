...
export class MatchesrestcontrollerApi {
     ...
     * @param id id
     */
    public getMatchesForSeasonUsingGET(id: number, extraHttpRequestParams?: any): Observable<Array<models.MatchDTO>> {
        return this.getMatchesForSeasonUsingGETWithHttpInfo(id, extraHttpRequestParams)
     ...
     * @param id id
     */
    public getMatchesForSeasonUsingGETWithHttpInfo(id: number, extraHttpRequestParams?: any): Observable<Response> {
        ...
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getMatchesForSeasonUsingGET.');
        }
