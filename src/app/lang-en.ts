...
export const LANG_EN_TRANS = {
    ...
    'text.faq1': 'First of all: welcome! To gain access to the restricted pages of the website, you have to register. After registration, the administrator can activate your account and give you access. When this is done, you can log in and you will have access.',
    'title.faq2': 'I forgot my password, what should I do?',
    'text.faq2': 'Do not panic! You can reset your password by requesting a password reset code. Fill in your email address you used to register and you will receive an email with a code (this code is valid for 1 day!) to reset your password.<br/>If you have forgotten your email address: send an email to the administrator.',
