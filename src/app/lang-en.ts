...
export const LANG_EN_TRANS = {
    ...
    'text.registration.succes': '<h4>The registration was successful.</h4></br>' +
        'Your account will have to be activated by the administrator. ' +
        'You will be notified of this action.</br>Afterwards, you can try to login.</br></br>Have a lot of fun on this website!',
